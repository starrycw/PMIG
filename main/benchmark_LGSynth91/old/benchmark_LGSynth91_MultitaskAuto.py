...
for task_to_be_exec in list_tasks_to_be_exec:
    ...
    # Opti mig_1
    if not opti_sub_graphs:
        mig_1 = copy.deepcopy(mig_1_raw)
    else:
        opti_s1_obj = pmig_ops.PMIG_optimization()
        opti_s1_obj.initialization(mig_obj=mig_1_raw, n_random_veri=task_n_random_veri)
        opti_s1_obj.opti_clean_pos_by_type()
        opti_s1_obj.opti_clean_irrelevant_nodes()
